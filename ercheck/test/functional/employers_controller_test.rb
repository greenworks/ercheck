...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { address: @employer.address, city: @employer.city, employer_code: @employer.employer_code, name: @employer.name }
    end
  ...
  test "should update employer" do
    put :update, id: @employer, employer: { address: @employer.address, city: @employer.city, employer_code: @employer.employer_code, name: @employer.name }
    assert_redirected_to employer_path(assigns(:employer))
  end
